...
export default function DetectionTips() {
  const tips = [
    {
      icon: Image,
      text: "Use a clear, high-resolution medical image.",
    },
    {
      icon: ScanLine,
      text: "Make sure the relevant region is clearly visible.",
    },
    {
      icon: CircleAlert,
      text: "Avoid heavily blurred, cropped, or distorted images.",
    },
  ];
